- figure out how to deploy app (hugginface?)
- need to add images to project description in submission
...
- replace realizeai & patientGPT github links (in sidebar) with link to the README file that has appropriate application details
